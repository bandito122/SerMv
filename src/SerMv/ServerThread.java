...
public class ServerThread extends Thread
{
    ...
    private SourceTaches tachesAExecuter; // taches à exécuté par les threads
    ...
    public void run()
    {
        ...
        Integer port_TRAMAP = Integer.valueOf(FichierConfig.getProperty("DISMAP").toString());
